...
public class Core
{
	...
	private String makeRequest(Map<String, Object> params, String appKey)
	{
		...
		return requester.sendSecurePostRequestJsonRpc(requestString, appKey);
	}
	...
	// System.out.println(dirPrefix + "/certs/client-2048.p12");
	...
	// + responseObject.getSessionToken() + " status: "
	// + responseObject.getLoginStatus());
	//
	...
	// *
	// *
	// * List<EventTypeResult> r =
	// * jsonOperations.listEventTypes(marketFilter, applicationKey,
	// * sessionToken);
	// *
	// *
	// * String result =
	// * getInstance().makeRequest(ApiNgOperation.LISTEVENTTYPES
	// * .getOperationName(), params, appKey, ssoId);
	// *
	// *
	// * public List<EventTypeResult> listEventTypes(MarketFilter
	// * filter, String appKey, String ssoId) throws APINGException {
	// * Map<String, Object> params = new HashMap<String, Object>();
	// * params.put(FILTER, filter); params.put(LOCALE, locale);
	// * String result =
	// * getInstance().makeRequest(ApiNgOperation.LISTEVENTTYPES
	// * .getOperationName(), params, appKey, ssoId);
	...
	// * System.out.println("\nResponse: "+result);
	// *
	// * EventTypeResultContainer container =
	// * JsonConverter.convertFromJson(result,
	// * EventTypeResultContainer.class); if(container.getError() !=
	// * null) throw
	// * container.getError().getData().getAPINGException();
	// *
	...
	// *
	// *
	// * protected String makeRequest(String operation, Map<String,
	// * Object> params, String appKey, String ssoToken) { String
	// * requestString; //Handling the JSON-RPC request JsonrpcRequest
	// * request = new JsonrpcRequest(); request.setId("1");
	// * request.setMethod
	// * (ApiNGDemo.getProp().getProperty("SPORTS_APING_V1_0") +
	// * operation); request.setParams(params);
	// *
	// * requestString = JsonConverter.convertToJson(request);
	// * if(ApiNGDemo.isDebug())
	// * System.out.println("\nRequest: "+requestString);
	// *
	// * //We need to pass the "sendPostRequest" method a string in
	// * util format: requestString HttpUtil requester = new
	// * HttpUtil(); return
	// * requester.sendPostRequestJsonRpc(requestString, operation,
	// * appKey, ssoToken);
	// */
	// }
	// } finally
	...
	{
		// NEW CODE NEED TO FIX HTTPUTILS FOR SSL FIRST TO WORK
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("username", username);
		params.put("password", password);
		// params.put("locale", Locale.getDefault().toString());

		String result = makeRequest(params, liveKey);
		System.out.println("\nResponse: " + result);

		LoginResponse resp = JsonConverter.convertFromJson(result,
				LoginResponse.class);
		if (resp.getLoginStatus() == null)
			System.out.println("err");

		// System.out.println(resp.getLoginStatus());
		// System.out.println(resp.getSessionToken());
		// return container.getResult();
	}
	...
	// SSLContext ctx = SSLContext.getInstance("TLS");
	// //KeyManager[] keyManagers = getKeyManagers("pkcs12",new
	// FileInputStream(new File(dirPrefix + "\\certs\\client-2048.p12")),
	// filePassword);
	// KeyManager[] keyManagers = getKeyManagers("pkcs12",new
	// FileInputStream(new File(dirPrefix + "/certs/client-2048.p12")),
	// filePassword);
	...
	// gson.fromJson(EntityUtils.toString(entity), LoginResponse.class);
	// System.out.println(responseObject);
	// System.out.println("Response:\nsession token: " +
	// responseObject.sessionToken + " status: " + responseObject.loginStatus);
	//
	// List<EventTypeResult> r = listEventTypes(new MarketFilter(), liveKey,
	// responseObject.sessionToken);
	//
	// /*
	//
	//
	...
	// *
	// * String result =
	// getInstance().makeRequest(ApiNgOperation.LISTEVENTTYPES.getOperationName(),
	// params, appKey, ssoId);
	// *
	// *
	// * public List<EventTypeResult> listEventTypes(MarketFilter filter, String
	// appKey, String ssoId) throws APINGException {
	// Map<String, Object> params = new HashMap<String, Object>();
	...
	//
	// EventTypeResultContainer container =
	// JsonConverter.convertFromJson(result, EventTypeResultContainer.class);
	...
	// *
	// *
	// * protected String makeRequest(String operation, Map<String, Object>
	// params, String appKey, String ssoToken) {
	// String requestString;
	...
	// requestString
	// HttpUtil requester = new HttpUtil();
	// return requester.sendPostRequestJsonRpc(requestString, operation, appKey,
	// ssoToken);
	//
	// */
	// }
	...
	// MatchProjection matchProjection, String currencyCode, String appKey,
	// String ssoId)
	// {
	// Map<String, Object> params = new HashMap<String, Object>();
	// params.put(LOCALE, locale);
	...
	// String result =
	// getInstance().makeRequest(ApiNgOperation.LISTMARKETBOOK.getOperationName(),
	// params, appKey, ssoId);
	// System.out.println("\nResponse: "+result);
	//
	// ListMarketBooksContainer container =
	// JsonConverter.convertFromJson(result, ListMarketBooksContainer.class);
	//
	// if(container.getError() != null)
	// throw container.getError().getData().getAPINGException();
	//
	...
	// MarketSort sort, String maxResult, String appKey, String ssoId) throws
	// APINGException
	// {
	// Map<String, Object> params = new HashMap<String, Object>();
	// params.put(LOCALE, locale);
	...
	// String result =
	// getInstance().makeRequest(ApiNgOperation.LISTMARKETCATALOGUE.getOperationName(),
	// params, appKey, ssoId);
	// if(ApiNGDemo.isDebug())
	// System.out.println("\nResponse: "+result);
	//
	// ListMarketCatalogueContainer container =
	// JsonConverter.convertFromJson(result,
