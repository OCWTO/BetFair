	...
	{	
		...
		try
		{
			...
			if (entity != null)
			{
				...
				System.out.println("Response:\nsession token: " + responseObject.getSessionToken() + " status: " + responseObject.getLoginStatus());
				
				List<EventTypeResult> r = listEventTypes(new MarketFilter(), liveKey, responseObject.getSessionToken());
...
//		System.out.println("\nResponse: " + result);
//
//		LoginResponse resp = JsonConverter.convertFromJson(result, LoginResponse.class);
...
//	}
	...
	protected String makeRequest(String operation, Map<String, Object> params, String appKey, String ssoToken) 
	{
	    ...
	    public List<MarketBook> listMarketBook(List<String> marketIds, PriceProjection priceProjection, OrderProjection orderProjection,
	            MatchProjection matchProjection, String currencyCode, String appKey, String ssoId)
	    {
				Map<String, Object> params = new HashMap<String, Object>();
				params.put(LOCALE, locale);
